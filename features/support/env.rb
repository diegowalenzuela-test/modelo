...
if ENV['ti']
  $ambiente = "ti"
  $endpoint = "http://rules-engine-hotels.k8s-ti-cvc.com.br/CvcRulesEngineHotelMarkup/HotelMarkupService"
elsif ENV['homolog']
  $ambiente = "qa"
  $endpoint = "http://rules-engine-hotels.k8s-qa-cvc.com.br/CvcRulesEngineHotelMarkup/HotelMarkupService"
elsif ENV['prod']
  $ambiente = "prod"
  $endpoint = "http://rules-engine-hotels.k8s-cvc.com.br/CvcRulesEngineHotelMarkup/HotelMarkupService"
end
